...
// ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?//  Low-level read helpers
...
static float ReadFloatF(const uint8_t* b, size_t sz,
                        uint32_t table_pos, int id, float def = 0.0f)
{
    uint32_t raw = ReadU32F(b, sz, table_pos, id);
...
// ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?//  Binary reader: customize_item_common_list
// ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?
...
// ?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€
//  Binary reader: character_list
// ?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€

static bool ReadCharacterBin(const std::vector<uint8_t>& data, ContentsBinData& bin)
{
    const uint8_t* b  = data.data();
    const size_t   sz = data.size();
    if (sz < 8) return false;
    ...
    uint32_t count = VecLength(b, sz, vec_pos);
    bin.characterEntries.reserve(count);
    ...
    for (uint32_t i = 0; i < count; ++i)
    {
        ...
        CharacterEntry e;
        { auto s = ReadStr(b, sz, ep,  0); strncpy_s(e.character_code,      s.c_str(), sizeof(e.character_code)      - 1); }
        e.name_hash     = ReadU32F(b, sz, ep,  1);
        e.is_enabled    = ReadBoolF(b, sz, ep, 2, true);
        e.is_selectable = ReadBoolF(b, sz, ep, 3, true);
        { auto s = ReadStr(b, sz, ep,  4); strncpy_s(e.group,              s.c_str(), sizeof(e.group)              - 1); }
        e.camera_offset = ReadFloatF(b, sz, ep, 5);
        e.is_playable   = ReadBoolF(b, sz, ep, 6, true);
        e.sort_order    = ReadU32F(b, sz, ep,  7);
        { auto s = ReadStr(b, sz, ep,  8); strncpy_s(e.full_name_key,      s.c_str(), sizeof(e.full_name_key)      - 1); }
        { auto s = ReadStr(b, sz, ep,  9); strncpy_s(e.short_name_jp_key,  s.c_str(), sizeof(e.short_name_jp_key)  - 1); }
        { auto s = ReadStr(b, sz, ep, 10); strncpy_s(e.short_name_key,     s.c_str(), sizeof(e.short_name_key)     - 1); }
        { auto s = ReadStr(b, sz, ep, 11); strncpy_s(e.origin_key,         s.c_str(), sizeof(e.origin_key)         - 1); }
        { auto s = ReadStr(b, sz, ep, 12); strncpy_s(e.fighting_style_key, s.c_str(), sizeof(e.fighting_style_key) - 1); }
        { auto s = ReadStr(b, sz, ep, 13); strncpy_s(e.height_key,         s.c_str(), sizeof(e.height_key)         - 1); }
        { auto s = ReadStr(b, sz, ep, 14); strncpy_s(e.weight_key,         s.c_str(), sizeof(e.weight_key)         - 1); }

        bin.characterEntries.push_back(e);
    }
...
// ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?//  Low-level write helpers
// ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?
...
static void WF32(std::vector<uint8_t>& b, float v)
{
...
// ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?//  Binary writer: customize_item_common_list
//
...
// ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?//  Wide string helpers
// ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?
...
// ?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€
//  Binary writer: character_list
//
//  Entry table field layout (obj_size = 56):
//    Offset  4: character_code ref  (u32, id  0)
//    Offset  8: name_hash           (u32, id  1)
//    Offset 12: group ref           (u32, id  4)
//    Offset 16: camera_offset       (f32, id  5)
//    Offset 20: sort_order          (u32, id  7)
//    Offset 24: full_name_key ref   (u32, id  8)
//    Offset 28: short_name_jp ref   (u32, id  9)
//    Offset 32: short_name ref      (u32, id 10)
//    Offset 36: origin_key ref      (u32, id 11)
//    Offset 40: fighting_style ref  (u32, id 12)
//    Offset 44: height_key ref      (u32, id 13)
//    Offset 48: weight_key ref      (u32, id 14)
//    Offset 52: is_enabled          (bool, id  2)
//    Offset 53: is_selectable       (bool, id  3)
//    Offset 54: is_playable         (bool, id  6)
//    Offset 55: pad
// ?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€?€

static std::vector<uint8_t> BuildCharacterBin(const ContentsBinData& bin,
                                               uint8_t version = 1)
{
    std::vector<uint8_t> b;
    b.reserve(16 * 1024);
    ...
    Align(b, 4);
    uint32_t vec_pos = static_cast<uint32_t>(b.size());
    const uint32_t N = static_cast<uint32_t>(bin.characterEntries.size());
    W32(b, N);
    ...
    // vtable field offsets (15 fields, indexed by schema id)
    static const uint16_t k_entry_fields[15] = {
         4,  8, 52, 53, 12, 16, 54, 20, 24, 28, 32, 36, 40, 44, 48
    };
    ...
    for (uint32_t i = 0; i < N; ++i)
    {
        ...
        uint32_t entry_vtab  = WriteVtable(b, 56, k_entry_fields, 15);
        uint32_t entry_table = BeginTable(b, entry_vtab);
        PatchRef(b, entry_ref_slots[i], entry_table);

        uint32_t char_code_ref = static_cast<uint32_t>(b.size());
        W32(b, 0);                   // id  0, offset  4
        W32(b, e.name_hash);         // id  1, offset  8
        uint32_t group_ref = static_cast<uint32_t>(b.size());
        W32(b, 0);                   // id  4, offset 12
        WF32(b, e.camera_offset);    // id  5, offset 16
        W32(b, e.sort_order);        // id  7, offset 20
        uint32_t full_ref  = static_cast<uint32_t>(b.size()); W32(b, 0); // id  8, offset 24
        uint32_t jp_ref    = static_cast<uint32_t>(b.size()); W32(b, 0); // id  9, offset 28
        uint32_t sn_ref    = static_cast<uint32_t>(b.size()); W32(b, 0); // id 10, offset 32
        uint32_t ori_ref   = static_cast<uint32_t>(b.size()); W32(b, 0); // id 11, offset 36
        uint32_t style_ref = static_cast<uint32_t>(b.size()); W32(b, 0); // id 12, offset 40
        uint32_t ht_ref    = static_cast<uint32_t>(b.size()); W32(b, 0); // id 13, offset 44
        uint32_t wt_ref    = static_cast<uint32_t>(b.size()); W32(b, 0); // id 14, offset 48

        W8(b, e.is_enabled    ? 1 : 0);  // id  2, offset 52
        W8(b, e.is_selectable ? 1 : 0);  // id  3, offset 53
        W8(b, e.is_playable   ? 1 : 0);  // id  6, offset 54
        W8(b, 0);                         // padding ??56 bytes

        PatchRef(b, char_code_ref, WriteString(b, e.character_code));
        PatchRef(b, group_ref,     WriteString(b, e.group));
        PatchRef(b, full_ref,      WriteString(b, e.full_name_key));
        PatchRef(b, jp_ref,        WriteString(b, e.short_name_jp_key));
        PatchRef(b, sn_ref,        WriteString(b, e.short_name_key));
        PatchRef(b, ori_ref,       WriteString(b, e.origin_key));
        PatchRef(b, style_ref,     WriteString(b, e.fighting_style_key));
        PatchRef(b, ht_ref,        WriteString(b, e.height_key));
        PatchRef(b, wt_ref,        WriteString(b, e.weight_key));
    }
...
// ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?//  TSV helpers
// ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?
...
static bool WriteTsvCharacter(FILE* f, const ContentsBinData& bin)
{
    for (int i = 0; i < FieldNames::CharacterCount; ++i)
    {
        if (i > 0) fputc('\t', f);
        fputs(FieldNames::Character[i], f);
    }
    fputc('\n', f);

    for (const auto& e : bin.characterEntries)
    {
        fprintf(f, "%s\t%u\t%d\t%d\t%s\t%g\t%d\t%u\t%s\t%s\t%s\t%s\t%s\t%s\t%s\n",
            TsvEsc(e.character_code).c_str(),
            e.name_hash,
            e.is_enabled    ? 1 : 0,
            e.is_selectable ? 1 : 0,
            TsvEsc(e.group).c_str(),
            (double)e.camera_offset,
            e.is_playable   ? 1 : 0,
            e.sort_order,
            TsvEsc(e.full_name_key).c_str(),
            TsvEsc(e.short_name_jp_key).c_str(),
            TsvEsc(e.short_name_key).c_str(),
            TsvEsc(e.origin_key).c_str(),
            TsvEsc(e.fighting_style_key).c_str(),
            TsvEsc(e.height_key).c_str(),
            TsvEsc(e.weight_key).c_str()
        );
    }
    return true;
}

static bool ReadTsvCharacter(FILE* f, ContentsBinData& bin)
{
    char lineBuf[4096];
    size_t len;
    ...
    if (!fgets(lineBuf, sizeof(lineBuf), f)) return false;
    {
        ...
        while (len > 0 && (lineBuf[len - 1] == '\n' || lineBuf[len - 1] == '\r'))
            lineBuf[--len] = '\0';
        auto hf = SplitTsv(std::string(lineBuf));
        if ((int)hf.size() < FieldNames::CharacterCount) return false;
    }

    bin.characterEntries.clear();
    ...
    while (fgets(lineBuf, sizeof(lineBuf), f))
    {
        ...
        auto fields = SplitTsv(std::string(lineBuf));
        if ((int)fields.size() < FieldNames::CharacterCount) continue;

        CharacterEntry e;
        int fi = 0;
        auto Str  = [&](char* dst, size_t sz) { strncpy_s(dst, sz, fields[fi].c_str(), sz - 1); ++fi; };
        auto U32  = [&]() -> uint32_t { return (uint32_t)strtoul(fields[fi++].c_str(), nullptr, 10); };
        auto Bool = [&]() -> bool     { auto v = fields[fi++]; return v == "1" || v == "true"; };
        auto F32  = [&]() -> float    { return (float)atof(fields[fi++].c_str()); };

        Str(e.character_code,      sizeof(e.character_code));
        e.name_hash     = U32();
        e.is_enabled    = Bool();
        e.is_selectable = Bool();
        Str(e.group,               sizeof(e.group));
        e.camera_offset = F32();
        e.is_playable   = Bool();
        e.sort_order    = U32();
        Str(e.full_name_key,       sizeof(e.full_name_key));
        Str(e.short_name_jp_key,   sizeof(e.short_name_jp_key));
        Str(e.short_name_key,      sizeof(e.short_name_key));
        Str(e.origin_key,          sizeof(e.origin_key));
        Str(e.fighting_style_key,  sizeof(e.fighting_style_key));
        Str(e.height_key,          sizeof(e.height_key));
        Str(e.weight_key,          sizeof(e.weight_key));
...
// ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?//  Public API
// ?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?ï¿?
