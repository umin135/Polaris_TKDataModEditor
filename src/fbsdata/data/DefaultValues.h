...
namespace DefaultValues
{
    ...
    inline CustomizeItemCommonEntry CommonEntry()
    {
        ...
        e.item_id      = 20006001;
        e.item_no      = 1;
        strcpy_s(e.item_code,      "IP_grf_bdf_custom");
    ...
    inline CustomizeItemUniqueEntry UniqueEntry()
    {
        ...
        e.char_item_id   = 10006100;   // A=1(unique), XX=00, YY=00, ZZZ=001
        strcpy_s(e.asset_name,       "IP_");
        e.character_hash = 0;
        e.hash_1         = 0;
        strcpy_s(e.text_key,         "");
        strcpy_s(e.extra_text_key_1, "");
        strcpy_s(e.extra_text_key_2, "");
        e.flag_7         = false;
        e.unk_8          = 0;
        e.flag_9         = false;
        e.unk_10         = 0;
